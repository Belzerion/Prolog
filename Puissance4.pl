...
% Condition de victoire verticale : 4 jetons les uns après les autres sur une meme colonne
% Paramètres : G grille, J joueur
finJeuVert([L|_],J):- sublist([J,J,J,J], L),!.
finJeuVert([_|G],J):- finJeuVert(G,J).

% Condition de victoire horizontale : 4 jetons les uns après les autres sur une meme ligne
...
% Sinon jouer au plus près du centre quand meme.
